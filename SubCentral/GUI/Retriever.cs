...
namespace SubCentral.GUI
{
    public class Retriever
    {
        ...
        public Retriever(bool enabled, List<string> languageCodes, List<string> providers)
        {
      ...
      {            
        ...
        if (dialog != null)
        {
          ...
          dialog.DoModal(GUIWindowManager.ActiveWindow);
            ...
            {
                ShowMessage("Searching subtitles", "No subtitles found", "", "", "");
            }
        }
        ...
        private bool OnQueryStarting()
        {
            ...
            pDlgProgress.Reset();
            pDlgProgress.SetHeading("Searching subtitles");
        ...
        private void DownloadSubtitle(List<BasicMediaDetail> mediaDetails, List<SubtitleItem> allResults, int selectedIndex)
        {
            ...
            if (mediaDetails.Count != subtitleFiles.Count)
                throw new Exception(
                    "Video and subtitle file count mismatch! " +
                    "Video files: " + mediaDetails.Count +
                    "Subtitle files: " + subtitleFiles.Count);
            ...
            {                 
                ...
                string videoFileName = mediaDetail.File.FullName;
                ...
                if (targetFileExists)
                {
                    bool overwriteFile = ShowCustomYesNo("Subtitle file already exists",
        ...
        { 
            ...
            GUIPropertyManager.SetProperty("#selecteditem", mediaDetail.File.Name);
            dlg.SetHeading("");
            dlg.EnableButton(true);      
            dlg.SetButtonLabel("Cancel");
            return dlg;
        }    
        ...
        private void NotifyUserSubtitleDownloaded(BasicMediaDetail mediaDetail)
        {
            ...
            pDlgNotify.SetText("Subtitles downloaded");
